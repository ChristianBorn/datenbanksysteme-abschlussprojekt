<!-- Funktion zur Produktsuche nach Produktbezeichnung -->
<?php include ("auth.php"); ?>
<!-- Formular zur Sucheingabe -->
<form action="index.php?content=search_productname" method="post">
    <table align="center" bgcolor="#E0E0E0" cellspacing="5" cellpadding="5">
        <tr>
            <td align="center" colspan="2">
                <h3>Produktsuche nach Bezeichnung</h3>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <input type="text" name="produktname" size="30">
            </td>
            <td>
...
if (isset($_POST["submit"]))
{
    ...
    $produktname = strip_tags(trim($_POST['produktname']));
    ...
    else
    {
        ...
        $anfrage="SELECT Produkt.ProduktID, Produkt.Bezeichnung AS Produkt_Bezeichnung, Beschreibung, 
                    ...
                    WHERE Bezeichnung LIKE '$produktname%'
                    GROUP BY
                        Produkt.ProduktID
                    ORDER BY
                        Durchschnitt DESC";
